...
square.MouseButton2Click:connect(function()
...
square.MouseButton2Down:connect(function()
...
square.InputBegan:connect(function(input)
    print("InputBegan - " .. tostring(input.UserInputType))
end)

square.InputEnded:connect(function(input)
    print("InputEnded - " .. tostring(input.UserInputType))
end)

square.InputChanged:connect(function(input)
    print("InputChanged - " .. tostring(input.UserInputType))
end)
]]
